...
const fakeCodexAdapter: CodexAdapter.CodexAdapterShape = {
  ...
  capabilities: { sessionModelSwitch: "in-session", integrationTransport: "vendor-app-server" },
  startSession: vi.fn(),
  sendTurn: vi.fn(),
  interruptTurn: vi.fn(),
...
const fakeClaudeAdapter: ClaudeAdapter.ClaudeAdapterShape = {
  ...
  capabilities: { sessionModelSwitch: "in-session", integrationTransport: "vendor-sdk" },
  startSession: vi.fn(),
  sendTurn: vi.fn(),
  interruptTurn: vi.fn(),
  respondToRequest: vi.fn(),
