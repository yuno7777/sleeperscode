...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetAgentCatalog]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetAgentInstallPlan]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetAgentInstallations]: AuthOrchestrationReadScope,
  [WS_METHODS.serverInstallAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverUninstallAgent]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.serverGetTaskAnalytics]: AuthOrchestrationReadScope,
  [WS_METHODS.serverClearTaskAnalytics]: AuthOrchestrationOperateScope,
