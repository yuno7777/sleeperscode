...
function mapProjectShellRow(
  ...
  return {
    ...
    scripts: row.scripts,
    sharedProviderConfiguration: row.sharedProviderConfiguration,
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    sharedProviderConfiguration: option.value.sharedProviderConfiguration,
                    handoffs: option.value.handoffs,
                    knowledgeNotes: option.value.knowledgeNotes,
