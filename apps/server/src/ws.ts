...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const taskAnalytics = yield* TaskAnalyticsService.TaskAnalyticsService;
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverGetAgentCatalog]: (input) =>
        ...
        [WS_METHODS.serverSetTaskFeedback]: (input) =>
          observeRpcEffect(WS_METHODS.serverSetTaskFeedback, taskAnalytics.setFeedback(input), {
            "rpc.aggregate": "server",
          }),
