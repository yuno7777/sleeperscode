...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Sleepers Code (Dev).app",
      "Sleepers Code (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Sleepers Code (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Sleepers Code (Dev).app/Contents/MacOS/Sleepers Code (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Sleepers Code (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/Sleepers Code (Dev).app/Contents/MacOS/Electron'",
    );
