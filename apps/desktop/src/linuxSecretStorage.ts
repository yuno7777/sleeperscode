...
function getGnomeKeyringRemediationMessage(): string {
  return "Sleepers Code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Sleepers Code.";
}

function getKWalletRemediationMessage(): string {
  return "Sleepers Code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Sleepers Code.";
}
