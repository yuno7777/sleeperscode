    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Sleepers Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Sleepers Code to connect to coding-agent servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Sleepers Code to access your camera so you can scan pairing QR codes.",
