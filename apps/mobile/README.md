# Sleepers Code Mobile

> [!WARNING]
> Sleepers Code Mobile is currently in development and is not distributed yet. If you want to try it out, you can build it from source.
...
- `development`: Expo dev client, installable side-by-side as `Sleepers Code Dev`
- `preview`: persistent internal preview build, installable side-by-side as `Sleepers Code Preview`
- `production`: store/release build as `Sleepers Code`
