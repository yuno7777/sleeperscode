export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/sleepers-code-ios-1024.png",
  productionMacIconPng: "assets/prod/sleepers-code-macos-1024.png",
  productionLinuxIconPng: "assets/prod/sleepers-code-universal-1024.png",
  productionWindowsIconIco: "assets/prod/sleepers-code-windows.ico",
  productionWebFaviconIco: "assets/prod/sleepers-code-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/sleepers-code-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/sleepers-code-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/sleepers-code-web-apple-touch-180.png",
