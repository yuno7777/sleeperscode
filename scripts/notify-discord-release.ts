  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Sleepers Code prerelease is available for nightly testers."
          : "A new Sleepers Code latest release is available.",
...
).pipe(Command.withDescription("Post a Sleepers Code release announcement to Discord."));
